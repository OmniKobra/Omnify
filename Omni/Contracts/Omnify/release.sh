...
source .env
# AVALANCHE
forge script --chain 43114 script/omnify.s.sol:MyScript --rpc-url $AVALANCHE_RPC_URL --broadcast --verify --via-ir --optimize -vvvv
#OPTIMISM
...
#BSC
forge script --chain 56 script/omnify.s.sol:MyScript --rpc-url $BNB_RPC_URL --broadcast --verify --via-ir --optimize -vvvv
#ARBITRUM
...
#ZKSYNC
#forge script --use 0.8.24 --legacy --gas-estimate-multiplier 130 --chain 324 script/omnify.s.sol:MyScript --zksync --rpc-url https://mainnet.era.zksync.io --broadcast --slow --verify --via-ir --optimize -vvvv
