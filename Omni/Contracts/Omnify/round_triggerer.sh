...
#APE
forge script --legacy --gas-estimate-multiplier 130 --chain 33139 script/roundtriggerer.s.sol:RoundTrigger --rpc-url $APE_RPC_URL --broadcast --via-ir -vvvv --sig 'run(address)' '0x883bA282D409e0E984Bef70B338f641D0045942F'
#POLYGON
