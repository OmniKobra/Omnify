...
contract MyScript is Script {
    ...
    */
    ...
    function run() external {
        ...
        address lzEndpoint = address(0x0Af59750D5dB5460E5d89E268C474d5F7407c061);
        uint32 _paramChainId = 30420;

        uint8 _paramNativeDecimals = 6;

        uint256 _paramProposalFee = 66600000; //$9.99
        uint256 _paramTier2Fee = 66600000; //$9.99
        uint256 _paramFeePerInstallment = 33000000; //$4.95
        uint256 _paramContractFee = 33000000; //$4.95
        uint256 _paramBridgeFee = 33000000; //$4.95
        uint256 _paramDepositFee = 26330000; //$3.95
        uint256 _paramBenefFee = 6660000; // $1
        uint256 _paramTier1Fee = 6660000; //$1
        uint256 _paramAltcoinFee = 13330000; //$2
        uint256 _paramTier3Fee = 660000000; //$99
        uint256 _paramTier4Fee = 1100000000; //$165
        uint256 pricePerCoin = 2800000;//$0.42
        uint256 _paramFeePerPayment = 2800000; //$0.42

        uint256 _paramTier1HigherThreshold = 9999_999999;
        uint256 _paramTier2HigherThreshold = 99999_999999;
        uint256 _paramTier3HigherThreshold = 999999_999999;
