...
//block time is the number of seconds that have passed since January 1st 1970
...
class Utils {
  ...
  static const String layerzeroUrl =
      "https://github.com/OmniKobra/Omnify/blob/main/assets/LayerZero_emblem.png?raw=true";
  ...
  static const String governUrl =
      "https://github.com/OmniKobra/Omnify/blob/main/assets/omni%20governance%202.png?raw=true";
  static const String goldrushUrl =
      "https://github.com/OmniKobra/Omnify/blob/main/assets/GoldRush%20-%20Logomark.png?raw=true";
  ...
  static CryptoAsset generateNativeUSDT(Chain c) {
    ...
    return CryptoAsset(
        address: address, symbol: symbol, decimals: decimals, logoUrl: logo);
  }
