abstract class AppLanguage {
  ...
  final carDescription4 =
      "Migrate or return bridged tokens between Avalanche, Optimism, Binance Smart Chain, Fantom, Mantle, Gnosis, Celo, Tron, Arbitrum, ApeChain, Polygon, Base, Linea, Scroll, Blast, and ZKsync.\nUses lock and mint / burn on return functionality";
  ...
  String governance0(int roundInterval, int coinholdDuration) =>
      "Omnify is governed by \$OFY, its utility token. Profits collected are distributed in distribution rounds every $roundInterval days.\n \$OFY should be received $coinholdDuration days before withdrawing from a distribution round.\n \$OFY is also needed to vote on proposals. \n 1 OFY = 1 SHARE = 1 VOTE";
