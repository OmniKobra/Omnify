...
class EN_Language implements AppLanguage {
  ...
  final transfer7 = "Recipient Address";
  ...
  final trust15 = "Add a Beneficiary";
  final trust16 = "Owner(s)";
  final trust17 = "Add an owner";
  final trust18 = "Done";
  final trust19 = "Add a Beneficiary";
  final trust20 = "Add an Owner";
  ...
  final downpaymentValidator = "Minimum remainder: ";
  ...
  final transactions2 = "No transactions found";
  ...
  final wcsheet3 = "Connect from the wallet by scanning a QR code shown here.";
